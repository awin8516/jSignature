...
var _BezierCurve = __webpack_require__(23);
...
var _ForeignObjectRenderer = __webpack_require__(16);
...
var _border = __webpack_require__(8);
...
var _padding = __webpack_require__(30);
...
var _visibility = __webpack_require__(33);
...
var _punycode = __webpack_require__(35);
...
var _NodeParser = __webpack_require__(20);
...
var _ImageLoader = __webpack_require__(18);
...
var html2canvas = function html2canvas(element, conf) {
	...
	//windowBounds.left = element.offsetParent.offsetLeft;
	//windowBounds.top = element.offsetParent.offsetTop;
	bounds.width = element.clientWidth;
	bounds.height = element.clientHeight;
	
	//alert(windowBounds.left);
	/*
	var bud = {
		left : node.offsetParent.offsetLeft,
		top : node.offsetParent.offsetTop,
		right : node.ownerDocument.defaultView.innerWidth-node.offsetParent.clientWidth-node.offsetParent.offsetLeft,
		bottom : node.ownerDocument.defaultView.innerHeight-node.offsetParent.clientHeight-node.offsetParent.offsetTop,
		width : node.offsetParent.clientWidth,
		height : node.offsetParent.clientHeight
	};
	var _width = (node.clientWidth + bud.left+bud.right);
	var _height = (node.clientHeight + bud.top+bud.bottom);
	*/
    ...
    var result = _Feature2.default.SUPPORT_FOREIGNOBJECT_DRAWING.then(function (supportForeignObject) {
        ...
        }(new _Clone.DocumentCloner(element, options, logger, true)) : (0, _Clone.cloneWindow)(ownerDocument,bounds, element, options, logger).then(function (_ref) {
            alert(4);
...
var _StackingContext = __webpack_require__(21);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(36)(module), __webpack_require__(37)))
...
var _Angle = __webpack_require__(41);
